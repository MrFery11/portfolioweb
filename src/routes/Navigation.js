...
function Navigation() {
  ...
  const navItems = [
    ...
    { id: 2, name: "Projects", to: projectsClick },
        ...
        <Container>
          <Toolbar>
            ...
            <Box sx={{ display: { xs: "none", sm: "block" } }}>
              {navItems.map((item) => (
                <Button onClick={item.to} key={item.id} color="tertiary">
                  {item.name}
                </Button>
              ))}
            </Box>
        ...
        >
          ...
          >
            <Container>
              ...
              <Divider color="#0057a9" sx={{ mt: 5, mb: 3 }} />
              <Grid container spacing={1}>
                <Grid item sm={8}>
                  <Typography color="#ffffff" sx={{ fontSize: "13px" }}>
